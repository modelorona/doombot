...
##            w.create_line(self.vertices[i][0], self.vertices[i][1], self.vertices[i+1][0], self.vertices[i+1][1], fill="red")
##            print(self.vertices[i][0], self.vertices[i][1], self.vertices[i+1][0], self.vertices[i+1][1])
...
##        print("name is: " + self.name)
        ...
        for line in self.lines:
            ...
            if line.is_one_sided():
                ## one sided wall
                print("a: " + str(a) + " b: " + str(b) + " one sided wall")
                dwg.add(dwg.line(a, b, stroke='green', stroke_width=10))
            else:
                ## objects inside map
                print("a: " + str(a) + " b: " + str(b) + " object inside wall")
                dwg.add(dwg.line(a, b, stroke='red', stroke_width=3))
        mainloop()
        dwg.save()
...
class Line(object):
    ...
    def deet(self):
        print("a: " + str(self.a) + " b: " + str(self.b) + " left_side: " + str(self.left_side) + " right_side: " + str(self.right_side)) 
